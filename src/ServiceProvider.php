...
namespace Playground\Make\Resource;
...
/**
 * \Playground\Make\Resource\ServiceProvider
 */
class ServiceProvider extends AuthServiceProvider
{
    public const VERSION = '73.0.0';

    public string $package = 'playground-make-resource';
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/config/playground-make-resource.php',
    ...
    public function about(): void
    {
        ...
        AboutCommand::add('Playground: Make Resource', fn () => [
